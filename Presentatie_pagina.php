...
<html>
	...
	<body class="container col-md-12">
		<header class="row">	
			<nav class="navbar navbar-light  col-12 col-md-12">
			  <a class="logo" href=""><img class="align-items-center logo" src="img/logo.png"></a>
			  <div class="row">
			  	<div class="login">
				 	<a class="col-md-12" href="inlogpagina.php">Login</a>
				</div>
				<div class="register">
					 <a class="col-md-12" href="register.php">Registreren</a>
				</div>
			</div>
			  <hr class="line">
			</nav>
       ...
       <main class="col-md-12 d-sm-block col-sm-12">
			...
			<section class="row col-md-12">
				<article class="col-12 col-md-12 col-lg-8 mx-auto">
